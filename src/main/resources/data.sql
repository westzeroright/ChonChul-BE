INSERT INTO user (id, created_at, updated_at, deleted_at, number, name, department, phone_number, email, role)
VALUES (1, NOW(), NOW(), null, 221965, '서영우', '자연과학대학 수학과', '010-7731-3160', 'me031007@jnu.ac.kr', 'STUDENT');
...
INSERT INTO lecture (id, created_at, updated_at, deleted_at, name, code, time, place, teacher_id)
...
INSERT INTO student_lecture (id, created_at, updated_at, deleted_at, student_id, lecture_id)
VALUES (1, NOW(), NOW(), null, 1, 1),
       (2, NOW(), NOW(), null, 1, 2),
       (3, NOW(), NOW(), null, 1, 3);

INSERT INTO session (id, created_at, updated_at, deleted_at, week, date, lecture_id)
