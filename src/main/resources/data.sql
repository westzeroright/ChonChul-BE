...
INSERT INTO user (id, created_at, updated_at, deleted_at, number, name, department, phone_number, email, role) VALUES
                                                             (2, NOW(), NOW(), null,null,'김명진',null,null,null,'TEACHER'), (3, NOW(), NOW(), null,null,'조종택',null,null,null,'TEACHER'),(4, NOW(), NOW(), null,null,'권도용',null,null,null,'TEACHER');

INSERT INTO student (id) VALUES (1);

INSERT INTO teacher (id) VALUES (2),(3),(4);

INSERT INTO lecture (id, created_at, updated_at, deleted_at, name, code, place, teacher_id) VALUES
                                                            (1, NOW(), NOW(), null, '임베디드소프트웨어', 'ECE3088-2', '공7-219',2),
                                                            (2, NOW(), NOW(), null, '미분기하1및실습', 'MTH3012-1', '자1-437',3),
                                                            (3, NOW(), NOW(), null, '암호학입문', 'MTH4027-1', '자1-301',4);
